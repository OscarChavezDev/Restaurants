...
import { CheckCircle, XCircle, ExternalLink, Calendar, Star, Users, UtensilsCrossed } from 'lucide-react';
...
export function AdminRestaurantList() {
  ...
  const restaurants = adminData?.content;
  const total = adminData?.totalElements;
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Aprueba o rechaza restaurantes del sistema
          </p>
        </div>
      </div>
